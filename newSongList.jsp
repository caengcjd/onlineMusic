...
<table width="323" height="60" border="0" cellpadding="0" cellspacing="0">
        <tr>
  <td   width="400px"    background="images/main_title.jpg">&nbsp;&nbsp;<span style="font-weight:bold; color:#DD6400"><%=typeArray[i][1]%></span><a style="color:#FA6E00;" href="song.do?action=songQuery&songType_more=<%=typeArray[i][0]%>">&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;更多>></a>&nbsp;</td>
  </tr>
